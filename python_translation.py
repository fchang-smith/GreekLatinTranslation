...
# source_file_path = (
#     "/Users/alinemarrap/Howe Annotations/GreekLatinTranslation/PH2219 - IG II2 1.txt"
# )
# new_file_path = "/Users/alinemarrap/Howe Annotations/GreekLatinTranslation/test.txt"

# python3.11 filename.py sourcefile newfile
...
def main():
    ...
    try:
        # if len(sys.argv) == 1:
        #   print("Syntax is python3.11 filename.py sourcefile newfile")
        if len(arguments) != 2:
            print(f"Syntax is python3.11 '{sys.argv[0]}' sourcefile newfile")
